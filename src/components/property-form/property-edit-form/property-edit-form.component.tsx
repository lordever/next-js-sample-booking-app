...
import { FormFieldsType, SellerInfo } from '../property-form.model';
  ...
  useEffect(() => {
    ...
    const fetchPropertyData = async () => {
      try {
        ...
        console.error('Error by fetching property by id: ', error);
        toast.error(`Can't get property by id: ${id}`);
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleChange = (
    ...
    if (name.includes('.')) {
      ...
      setFields(prevFields => {
        const values: FormFieldsType = prevFields?.[
          outerKey as keyof FormFieldsType
        ] as Partial<
          PropertyModel & {
